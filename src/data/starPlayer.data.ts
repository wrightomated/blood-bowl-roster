...
const grim: StarPlayer = {
    ...
    playsFor: ['Halfling Thimble Cup','Old World Classic','Worlds Edge Superleague'],
...
const karla: StarPlayer = {
    ...
    playsFor: ['Halfling Thimble Cup','Lustrian Superleague','Old World Classic'],
    skills: [13,14,4,6,71],
    cost: 210,
...
const grombrindal: StarPlayer = {
    ...
    playsFor: ['Halfling Thimble Cup', 'Lustrian Superleague', 'Old World Classic', 'Worlds Edge Superleague'],
